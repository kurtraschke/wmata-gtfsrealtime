...
public class WMATAAPIService {
  ...
  private Digester getStopDigester() {
    ...
    stopDigester.addCallMethod("StopsResp/Stops/Stop/Routes/a:string",
        "addRoute", 0); // so much for namespace support
  ...
  private Digester getRouteDigester() {
    ...
    routeDigester.addCallMethod("RoutesResp/Routes/Route/RouteID",
        "setRouteID", 0);
  ...
  private Digester getRouteScheduleDigester() {
    ...
    routeScheduleDigester.addObjectCreate("RouteScheduleInfo",
        WMATARouteScheduleInfo.class);

    routeScheduleDigester.addCallMethod("RouteScheduleInfo/Name", "setName", 0);

    routeScheduleDigester.addObjectCreate("RouteScheduleInfo/Direction0/Trip",
        WMATATrip.class);

    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction0/Trip/DirectionNum", "setDirectionNum", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction0/Trip/EndTime", "setEndTime", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction0/Trip/RouteID", "setRouteID", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction0/Trip/StartTime", "setStartTime", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction0/Trip/TripDirectionText",
        "setTripDirectionText", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction0/Trip/TripHeadsign", "setTripHeadsign", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction0/Trip/TripID", "setTripID", 0);

    routeScheduleDigester.addObjectCreate(
        "RouteScheduleInfo/Direction0/Trip/StopTimes/StopTime",
        WMATAStopTime.class);

    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction0/Trip/StopTimes/StopTime/StopID",
        "setStopID", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction0/Trip/StopTimes/StopTime/StopName",
        "setStopName", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction0/Trip/StopTimes/StopTime/StopSeq",
        "setStopSeq", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction0/Trip/StopTimes/StopTime/Time", "setTime",
        0);

    routeScheduleDigester.addSetNext(
        "RouteScheduleInfo/Direction0/Trip/StopTimes/StopTime", "addStopTime");
    routeScheduleDigester.addSetNext("RouteScheduleInfo/Direction0/Trip",
        "addDirection0Trip");

    routeScheduleDigester.addObjectCreate("RouteScheduleInfo/Direction1/Trip",
        WMATATrip.class);

    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction1/Trip/DirectionNum", "setDirectionNum", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction1/Trip/EndTime", "setEndTime", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction1/Trip/RouteID", "setRouteID", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction1/Trip/StartTime", "setStartTime", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction1/Trip/TripDirectionText",
        "setTripDirectionText", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction1/Trip/TripHeadsign", "setTripHeadsign", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction1/Trip/TripID", "setTripID", 0);

    routeScheduleDigester.addObjectCreate(
        "RouteScheduleInfo/Direction1/Trip/StopTimes/StopTime",
        WMATAStopTime.class);

    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction1/Trip/StopTimes/StopTime/StopID",
        "setStopID", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction1/Trip/StopTimes/StopTime/StopName",
        "setStopName", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction1/Trip/StopTimes/StopTime/StopSeq",
        "setStopSeq", 0);
    routeScheduleDigester.addCallMethod(
        "RouteScheduleInfo/Direction1/Trip/StopTimes/StopTime/Time", "setTime",
        0);

    routeScheduleDigester.addSetNext(
        "RouteScheduleInfo/Direction1/Trip/StopTimes/StopTime", "addStopTime");
    routeScheduleDigester.addSetNext("RouteScheduleInfo/Direction1/Trip",
        "addDirection1Trip");
  ...
  private Digester getAlertDigester() {
    ...
    alertDigester.addCallMethod("rss/channel/item/description",
        "setDescription", 0);
  ...
  public WMATARouteScheduleInfo downloadRouteScheduleInfo(String routeID,
      String date) throws IOException, SAXException {
    String url = "http://api.wmata.com/Bus.svc/RouteSchedule?includeVariations=false&date="
        + date
        + "&routeId="
  ...
  private Object digestUrl(String url, boolean cache, Digester digester)
      throws IOException, SAXException {
